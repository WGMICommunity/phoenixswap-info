...
function GlobalPage() {
  ...
  return (
    <PageWrapper>
      <ThemedBackground backgroundColor={transparentize(0.8, '#34fbeb')} />
      <ContentWrapper>
        <div>
          <AutoColumn gap="24px" style={{ paddingBottom: below800 ? '0' : '24px' }}>
            <TYPE.largeHeader>{below800 ? 'Protocol Analytics' : 'Phoenixswap Protocol Analytics'}</TYPE.largeHeader>
            <Search />
            <GlobalStats />
          </AutoColumn>
