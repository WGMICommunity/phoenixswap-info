...
const theme = (darkMode, color) => ({
  ...
  uniswapPink: darkMode ? '#34fbeb' : 'black',
  ...
  //primary colors
  primary1: darkMode ? '#2172E5' : '#34fbeb',
  primary2: darkMode ? '#3680E7' : '#34fbeb',
  primary3: darkMode ? '#4D8FEA' : '#34fbeb',
  primary4: darkMode ? '#376bad' : '#b0faf4',
  primary5: darkMode ? '#153d6f' : '#d0fbf8',

  // color text
  primaryText1: darkMode ? '#6da8ff' : '#34fbeb',

  // secondary colors
  secondary1: darkMode ? '#2172E5' : '#34fbeb',
  ...
  background: darkMode ? 'black' : `radial-gradient(50% 50% at 50% 50%, #34fbeb 0%, #fff 0%)`,
})
